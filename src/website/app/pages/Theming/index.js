...
export default function Theming(props: Props) {
  return (
    <div {...props}>
      ...
      {themeVariables.map((themeVariable, index) => {
        const title = Object.keys(themeVariable)[0];
        const values = Object.values(themeVariable)[0];
        const returnedValues = typeof values === 'function' ? values() : values;
        return (
          <div key={title}>
